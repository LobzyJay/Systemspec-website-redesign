      ...
      <head>
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){if(!location.pathname.startsWith('/design')){document.documentElement.setAttribute('data-splash','active');}try{if('scrollRestoration' in history)history.scrollRestoration='manual';}catch(e){}window.scrollTo(0,0);})();`,
          }}
        />
      </head>
      <body>
